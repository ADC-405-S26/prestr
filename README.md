...
- `create_ppt_report()` : Generate a `.pptx` file with a title slide and
  data table
- `auto_chart()` : Create bar, line, or scatter charts from a data frame
- `summarize_insights()` : Extract key statistics from numeric columns
